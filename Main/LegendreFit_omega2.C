...
void LegendreFit_omega2(TString inFile = "PHSD_omegatest.root",Double_t omega_value_start = 1.2, Int_t NITER_CENT = 10, Int_t NITER = 10, Double_t xmin = 1.086, Double_t nsig_bckg = 7.0, Double_t nsig = 3.0)
{
	TLatex latex;
	latex.SetNDC();
	...
	TH1D *hm0_before[NITER_CENT], *hm0_before_signal[NITER_CENT];
	...
	for(int iter_cent = 0; iter_cent < NITER_CENT; iter_cent++)
	{
		...
		hm0_before_signal[iter_cent] = (TH1D*)hm0_before[iter_cent]->Clone("hm0_before_sig_%d");

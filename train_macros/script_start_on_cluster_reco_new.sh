...
#
#SBATCH -D /lustre/home/user/n/nazarova/output/Reco/Analysis/Omega
...
#
#SBATCH -o /lustre/home/user/n/nazarova/output/Reco/Analysis/Omega/logs/slurm_%A_%a.out
#SBATCH -e /lustre/home/user/n/nazarova/output/Reco/Analysis/Omega/logs/slurm_%A_%a.err
#
...
export OUT_DIR=/lustre/home/user/n/nazarova/output/Reco/Analysis/Omega
...
cp ${MACRO_DIR}/MpdGlobalPolarizationRECO.cxx MpdGlobalPolarizationRECO.cxx
cp ${MACRO_DIR}/MpdGlobalPolarizationRECO.h MpdGlobalPolarizationRECO.h
...
cp ${MACRO_DIR}/hyperLinkDef.h hyperLinkDef.h
...
root -b -q MpdAnalysisTask2.cxx MpdLambdaPol.cxx MpdGlobalPolarizationRECO.cxx RunAnalyses.C\(\"${OUTFILE}\",\"analysis\",\"omega2\"\)

...
void LegendreFit_selections_train(TString inFileDir = "Directory_Path", TString outname = "Selections_Full.root", int NITER_CENT_START = 0, int NITER_CENT = 4, int NITER = 10, double xmin = 1.086, double nsig_bckg = 7.0, double nsig = 4.0)
{
	TLatex latex;
	latex.SetNDC();
	...
	for(int iter_cent = NITER_CENT_START; iter_cent < NITER_CENT; iter_cent++)
	{
